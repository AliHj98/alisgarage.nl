...
<body>
    ...
    <!-- Carousel Start -->
    <?php require_once( 'reuse/carousel.php'); ?>
    <!-- Carousel End -->

    
    <!-- Service Start -->
    <?php require_once( 'reuse/service.php'); ?>
    <!-- Service End -->


    <!-- About Start -->
    <?php require_once( 'reuse/about.php'); ?>
    <!-- About End -->


    <!-- Fact Start -->
    <?php require_once( 'reuse/fact.php'); ?>
    <!-- Fact End -->


    <!--BIG Service Start -->
    <?php require_once( 'reuse/big-service.php'); ?>
    <!--BIG Service End -->


    <!-- Booking Start -->
    <?php require_once( 'reuse/booking.php'); ?>
    <!-- Booking End -->
